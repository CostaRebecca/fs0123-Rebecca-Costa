...
*/
 ...
 let calcolaArea = function area (l1,l2) {
    return l1*l2
}
console.log(calcolaArea(2,3));
...
let result = function crazySum(a,b){
    if(a == b){
        return (a+b)*3;
    }else{
        return a+b;
...
let differenza = function crazyDiff (c){
    let risultato = c - 19;
...
console.log(epify('EPICODE rebecca'));
...
let strin1 = giveMeRandom(4);
console.log ([strin,strin1]);
