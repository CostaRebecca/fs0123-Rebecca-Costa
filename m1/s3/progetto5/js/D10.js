...
function number() {
  let randomm = Math.floor(Math.random() * 21);
  return randomm
...
function splitMe(string) {
  return string.split(' '); //tra gli apici ho messo lo spazio per far tagliare dove c'è lo spazio, se ci fosse stata la virgola avrei inserito(',')
}
...
console.log(deleteOne('Vada vada,non cincischi', true));
console.log(deleteOne('Ma è professore lei?', false));
...
function onlyLetters(stringa) {
  return stringa.replaceAll(/[0-9]/g, ''); // replaceAll accetta solo g per le altre utilizzare replace
}
console.log(onlyLetters('fewe6367'));

/* ESERCIZIO 6
  Crea una funzione chiamata "isThisAnEmail" che riceve una stringa come parametro e ritorna true se la stringa è un valido indirizzo email.
*/

function isThisAnEmail(strin) {
...
console.log(isThisAnEmail('mail@gmail.com'));
console.log(isThisAnEmail('mailgmailcom'));
