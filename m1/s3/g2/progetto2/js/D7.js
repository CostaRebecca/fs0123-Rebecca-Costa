...
}  console.log(conc('rebecca','napoli'));
...
console.log(somma([1,2,3,4,55,66]))
...
*/
function converti(lunghezza){
 for (let i = 0; i < lunghezza.length; i++){
  if(typeof lunghezza[i] === 'string'){
     lunghezza[i] = lunghezza[i].length;
  }
 } return lunghezza;
}

let lunghezza = ['Rebecca','prova'];
let frase = converti(lunghezza);
console.log(frase);
